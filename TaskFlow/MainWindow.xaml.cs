    ...
    public partial class MainWindow : Window
    {
        ...
        private void BtnAbout_Click(object sender, RoutedEventArgs e)
        {
            MessageBox.Show(this,
                "TaskFlow — учебное desktop-приложение на WPF .NET 9 с Supabase, Material Design 3 и AI-помощником.\n\nДля функции блокировки пользователей в Supabase нужна колонка users.is_blocked boolean default false.",
                "О программе",
                MessageBoxButton.OK,
